...
```text
npm i --save ect-ui@git+https://oauth2:GtxM6_QGdWiBxWx4yyy@git.iflytek.com/edu_fe_lib/ect/ect-ui.git#vue2
```

"ect-ui": "git+https://oauth2:[GtxM6_QGdWiBxWx-4yyy@git.iflytek.com](mailto:GtxM6_QGdWiBxWx-4yyy@git.iflytek.com)/edu_fe_lib/ect/ect-ui.git#v3.1.5
